...
public class KakaopayService {
	...
	public String payReady(CafeReservation cafeReservation) {
		System.out.println("페이레디 : " + cafeReservation);
	    ...
	    params.add("approval_url", "http://localhost:8080/cob/cafe/cafe_paySuccess");
	...
	public CafePayApproval payConfirm(String pg_token) {
