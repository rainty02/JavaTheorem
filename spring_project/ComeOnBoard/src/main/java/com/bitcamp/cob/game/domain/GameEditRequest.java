...
public class GameEditRequest {
	...
	public GameEditRequest(int gameIdx, String gameName, String gameSort, String gamePerson, String gameTime,
			String gameLmtAge, String gamePublisher, String gamePubDate, MultipartFile gamePhoto, String gameIntro,
			String gameRule, String gameVideo) {
	...
	public String toString() {
		return "GameEditRequest [gameIdx=" + gameIdx + ", gameName=" + gameName + ", gameSort=" + gameSort
				+ ", gamePerson=" + gamePerson + ", gameTime=" + gameTime + ", gameLmtAge=" + gameLmtAge
				+ ", gamePublisher=" + gamePublisher + ", gamePubDate=" + gamePubDate + ", gamePhoto=" + gamePhoto
