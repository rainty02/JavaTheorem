...
//		*오버라이딩
//		조상클래스로부터 상속받은 메서드의 *내용을 자손클래스에 맞게 재구성
//		조건
//		1. 상속의 관계
//		2. 하위클래스에서 수정
...
//		*다형성 (상속관계에서만 가능 *배열, for문을 사용할 수 있는 이유)
//		하나의 참조변수로 여러 타입의 객체를 참조할 수 있는 것
//		상위클래스타입의 참조변수로 하위클래스타입의 객체를 다룰 수 있는 것이 다형성이다
//		상위클래스타입 참조변수명 = 하위클래스의 인스턴스();
//		(상위클래스에 있는 멤버를 사용)사용할 멤버를 정의, 오버라이딩된 메소드가 있다면 상위클래스 메소드를 가려짐
		class Father {}
